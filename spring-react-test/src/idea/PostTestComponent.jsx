...
class PostTestComponent extends Component {
    ...
    onChange = (e) => {
        ...
        console.log('이건데 => ' + targetName);
        if(targetName == '0' || targetName == '1' || 
            targetName == '2' || targetName == '3' || 
            targetName == '4'){
            targetName *= 1;
        ...
        return (
            <div>
                ...
                <form>
                    ...
                    목적 : <input type="text" name="0" value={this.state.goodsList[0].content} onChange={this.onChange}/><br/> 
                    필요성 : <input type="text" name="1" value={this.state.goodsList[1].content} onChange={this.onChange}/><br/> 
                    전략 : <input type="text" name="2" value={this.state.goodsList[2].content} onChange={this.onChange}/><br/> 
                    우수성 : <input type="text" name="3" value={this.state.goodsList[3].content} onChange={this.onChange}/><br/> 
                    시장분석 : <input type="text" name="4" value={this.state.goodsList[4].content} onChange={this.onChange}/><br/> 
